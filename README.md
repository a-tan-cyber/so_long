...
1. Check that the map is non-empty.
2. Check that all rows have the same width.
3. Check that the border is made of walls.
4. Check allowed characters and required counts.
5. Run a flood-fill traversal from the player position.
